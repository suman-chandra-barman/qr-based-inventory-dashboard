...
import ViewAssignedCustomersModal from "@/components/modals/ViewAssignedCustomersModal";
import {
...
export function AssignProductTable({
  selectedCategory,
  onCategoryChange,
}: ProductTableProps) {
  ...
  const [isViewCustomersModalOpen, setIsViewCustomersModalOpen] =
    useState(false);
  const [viewProductId, setViewProductId] = useState<string | null>(null);
  const [viewProductName, setViewProductName] = useState<string>("");
  ...
  return (
    <div className="space-y-6">
                      ...
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          onClick={() => {
                            ...
                            setViewProductName(product.name);
      ...
      <ViewAssignedCustomersModal
        productId={viewProductId}
        productName={viewProductName}
        open={isViewCustomersModalOpen}
        onOpenChange={(open) => {
          setIsViewCustomersModalOpen(open);
          if (!open) {
