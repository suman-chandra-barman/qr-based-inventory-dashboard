...
import { useGetAboutUsQuery, useUpdateAboutUsMutation } from "../redux/api/api";

const EditAboutUsPage: React.FC = () => {
  const navigate = useNavigate();
  const { data, isLoading: loading } = useGetAboutUsQuery(undefined);
  const [updateAboutUs, { isLoading: updating }] = useUpdateAboutUsMutation();
